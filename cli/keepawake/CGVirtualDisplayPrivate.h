...
// Reverse-engineered private CoreGraphics headers for CGVirtualDisplay.
// Source: https://github.com/KhaosT/CGVirtualDisplay (used by BetterDisplay et al.)
// No kext, no root required just to create the display object itself.
//
